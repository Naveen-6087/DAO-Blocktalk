...
initial_supply = Web3.to_wei(100, "ether")
...
def deploy_contracts():
    ...
    print(f"GovernanceToken deployed: {governance_token.address}")
    ...
    print(f"TimeLock deployed: {governance_time_lock.address}")
    ...
    print(f"Governor deployed: {governor.address}")
    ...
    print(f"Box deployed: {box.address}")
